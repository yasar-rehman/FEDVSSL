...
def parse_args():
    ...
    parser.add_argument('--team', default='tcl', type=str, choices=['cam', 'tcl'], help='two data structures.')
    parser.add_argument('--out_path', default='./non_iid/', type=str, help='output directory path.')
    parser.add_argument('--input_path', default='/home/DATA/Kinetics-processed/annotations/train_in_official.txt', type=str, help='input index file')
...
def main():
    ...
    with open(input_path, 'r') as f:
        for line in f.readlines():
            ...
            name = line.split(' ')[0] if team == 'tcl' else line.split(' ')[0].split('/')[1]
