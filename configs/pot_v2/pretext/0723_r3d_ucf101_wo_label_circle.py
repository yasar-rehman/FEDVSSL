...
work_dir = './output/pot_v2/pretext/0723_r3d_ucf101_wo_label_circle'

model = dict(
    pot_head=dict(with_label_head=False, roi_grad=True, with_bn=False),
    force_circle=True
)
...
extra_hooks = [
    dict(type='ComposeDataHook',
         start_probs=[1.0, 0.0, 0.0],
         end_probs=[0.2, 0.4, 0.4])
]
