...
if __name__ == '__main__':
    ...
    ####################################################################################################################
    if args.batch_size:
        cfg.data.videos_per_gpu = args.batch_size   # the batch size here means batch on a single gpu, overall we use 4 gpu's
    if args.lr_rate:
        cfg.optimizer.lr =args.lr_rate # changing the learning rate of the optimizer

    # cfg.total_epochs = 50 # just for hyper parameter search 
    ###############################################################################################################
    ##############################################################################################################
    # create work_dir
