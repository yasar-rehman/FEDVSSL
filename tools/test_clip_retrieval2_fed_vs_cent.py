...
from pyvrl.apis import get_root_logger, test_clip_retrieval_fedvscent
...
def parse_args():
    ...
    default=["/home/root/yasar/SSFVRL/federated-unsupervised-learning/videoSSL/centralized_ctp/pretrain_27/epoch_90.pth",\
            "/home/root/yasar/cambridge_branch/federated-unsupervised-learning/videoSSL/reproduce_papers/glb_rounds_ctp_5c1e540r/glb_epochs/round-540-weights.npy.npz"],
    type=list, help='the checkpoint file to resume from')
    ...
    parser.add_argument('--ran_multip', type=float, help='random multiplier for torch.randn')
...
if __name__ == '__main__':
    ...
    results = test_clip_retrieval_fedvscent(model,
                                  train_dataset,
                                  test_dataset,
                                  cfg,
                                  args,
